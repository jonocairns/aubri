...
import { Collapse, Navbar, NavbarToggler, NavbarBrand, Nav as BsNav, NavItem, NavLink } from 'reactstrap';
            ...
            <Navbar color="faded" dark className="bg-dark px-4" expand="md">
                ...
                <Collapse isOpen={!collapsed} navbar>
                    <BsNav navbar className="d-flex ml-auto">
                        ...
                        <NavItem>
                            <NavLink href="https://github.com/jonocairns/audi">GitHub</NavLink>
                        </NavItem>
                    </BsNav>
                </Collapse>
            </Navbar>
