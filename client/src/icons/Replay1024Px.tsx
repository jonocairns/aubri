...
export const SvgReplay1024Px = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
    <defs>
      <path id="replay_10-24px_svg__a" d="M0 0h24v24H0V0z" />
    </defs>
    <clipPath id="replay_10-24px_svg__b">
      <use xlinkHref="#replay_10-24px_svg__a" overflow="visible" />
    </clipPath>
    <path
      ...
      clipPath="url(#replay_10-24px_svg__b)"
    />
  </svg>
);
