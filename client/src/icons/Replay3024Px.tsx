...
export const SvgReplay3024Px = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
    <defs>
      <path id="replay_30-24px_svg__a" d="M0 0h24v24H0V0z" />
    </defs>
    <clipPath id="replay_30-24px_svg__b">
      <use xlinkHref="#replay_30-24px_svg__a" overflow="visible" />
    </clipPath>
    <path
      ...
      clipPath="url(#replay_30-24px_svg__b)"
    />
  </svg>
);
export default SvgReplay3024Px;
